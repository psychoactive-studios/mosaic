...
export async function POST(req) {
  ...
  const message = {
    ...
    text: `Kia ora ${fullName},
          Great news! Your feedback on the ${pathway} has been approved and added to the Mosaic website at: ${window.location.href}. We’re thrilled to share your comments with the community.
          ${comment}
